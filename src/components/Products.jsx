  ...
  return (
    <section className='py-30'>
        ...
        <div className='flex items-center gap-4 justify-center mt-4'>
            <button className="px-3 py-1 bg-gradient-to-r from-purple-600 via-violet-600 to-violet-600 rounded-full text-white text-lg cursor-pointer hover:scale-105 transition-all duration-300">Products</button>
