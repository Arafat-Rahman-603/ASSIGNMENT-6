...
export default function Hero() {
  return (
    <section className="grid gap-10 md:grid-cols-2 grid-cols-1 justify-between items-center px-20 py-5 border-b-1 border-gray-200 mt-20">
      <div>
        ...
        <div className="flex gap-4 mt-4">
            <button className="px-4 py-2 bg-[#4F39F6] rounded-full text-white text-lg cursor-pointer hover:scale-105 transition-all duration-300">Explore Products</button>
